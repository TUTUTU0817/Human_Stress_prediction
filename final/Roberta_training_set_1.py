...
# 準備資料
df_data = pd.read_csv(f'./datasets/training_set/training_set_1_balance.csv')
...
# 儲存模型
trainer.save_model(f'./model/B_model_Roberta_1')
tokenizer.save_pretrained(f'./B_model_Roberta_1_tokenizer')
print('Model and tokenizer have been saved.')


# 評估模型
eval_results = trainer.evaluate()
print(f"Evaluation results for B_model_Roberta_1:")
print(eval_results)
